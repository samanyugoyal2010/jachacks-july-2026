...
export function IconAgentCollateral(props: IconProps) {
  return (
    <svg {...base} {...props}>
...
export function IconAgentAdvisor(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <title>Recourse Advisor</title>
      <path d="M12 3.5a6 6 0 0 0-3.5 10.9V17h7v-2.6A6 6 0 0 0 12 3.5Z" strokeLinejoin="round" />
      <path d="M9.5 20h5" />
    </svg>
  );
}
...
export const AGENT_ICONS: Record<AgentId, ComponentType<IconProps>> = {
  ...
  risk: IconAgentRisk,
  collateral: IconAgentCollateral,
  policy: IconAgentPolicy,
  adjudicator: IconAgentAdjudicator,
  advisor: IconAgentAdvisor,
};
