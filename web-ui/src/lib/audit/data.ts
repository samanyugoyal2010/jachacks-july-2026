...
export const AGENTS: Record<AgentId, Agent> = {
  ...
  collateral: {
    id: "collateral",
    name: "Collateral Analyst",
    role: "Asset Valuation",
    description:
      "Values pledged collateral and judges whether it is appraised and sufficient.",
    initials: "CA",
  },
  advisor: {
    id: "advisor",
    name: "Recourse Advisor",
    role: "Applicant Remediation",
    description:
      "Turns a decline into a concrete, numeric plan the applicant can act on and reapply with.",
    initials: "RC",
  },
  adjudicator: {
    id: "adjudicator",
